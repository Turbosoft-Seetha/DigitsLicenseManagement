<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="ListCustomer.aspx.cs" Inherits="DigitsLicenseManagement.BO_Digits.en.ListCustomer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Actions" runat="server">
    ...
    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel2">
        ...
        <%--<asp:LinkButton ID="lnkReset" runat="server" CssClass="btn btn-sm fw-bold btn-secondary" Text="Reset" CausesValidation="False" OnClick="lnkReset_Click"></asp:LinkButton>--%>
